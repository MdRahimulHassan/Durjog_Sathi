...
class TrackRescue extends StatefulWidget {
  const TrackRescue({super.key});

  @override
  State<TrackRescue> createState() => _TrackRescueState();
}

class _TrackRescueState extends State<TrackRescue> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Track Rescue Operation")),
      body: GoogleMap(
